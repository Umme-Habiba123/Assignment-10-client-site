...
const AboutMe = () => {
    return (
        <div className='w-10/12 mx-auto'>
            <h1 className='text-center text-4xl text-green-500 tagesschrift-regular mb-8'>Hello...</h1>
            ...
            <div className='flex flex-col-reverse lg:flex-row items-center justify-center gap-10'>
                ...
                <div className='lg:w-1/2'>
                    ...
                    <Link to={'/myDetails'}>
                        <button className='btn bg-green-800 hover:bg-white hover:text-black rounded-sm px-8 text-xl satisfy-regular text-white mt-6'>
